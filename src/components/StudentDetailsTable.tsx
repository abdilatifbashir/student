        ...
        <Table striped>
          ...
          <Table.Body>
            {studentData?.map((student: any) => (
              <Table.Row>
                <Table.Cell key={student.id}>{student.firstName}</Table.Cell>
                <Table.Cell key={student.id}>{student.lastName}</Table.Cell>
                <Table.Cell key={student.id}>{student.dob}</Table.Cell>
                <Table.Cell key={student.id}>{student.course}</Table.Cell>
                <Table.Cell key={student.id}>{`${student.hours}H`}</Table.Cell>
                <Table.Cell key={student.id}>{`${student.price} £`}</Table.Cell>
                <Table.Cell
                  key={student.id}
